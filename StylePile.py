...
class Script(scripts.Script):
    ...
    def ui(self, is_img2img):
        ...
        with gr.Tab("Directions") as StyleTab:
            gr.Gallery(value=ResultDirectionImages, show_label=False, grid=(3, 3, 3, 3, 4, 4), container=False)

        with gr.Tab("Moods"):
            gr.Gallery(value=ResultMoodImages, show_label=False, grid=(3, 3, 3, 3, 4, 4), container=False)

        with gr.Tab("Artists"):
            gr.Gallery(value=ResultArtistImages, show_label=False, grid=(2, 2, 2, 2, 3, 3), container=False)
            
        with gr.Tab("Art movements"):
            gr.Gallery(value=ArtMovementImages, show_label=False, grid=(3, 3, 3, 3, 4, 4), container=False)
            
        with gr.Tab("Colors"):
            gr.Gallery(value=ResultColorImages, show_label=False, grid=(3, 3, 3, 3, 4, 4), container=False)
